### Cálculo de los AVAD para diabetes mellitus tipo 2 en Argentina (AVAD = AVP + AVD)
...
## AVD por grupo edad ENFR
serie_AVD_enfr <- read_csv("Bases de datos/clean/prev_dm_avd.csv")
